...
namespace rs
{
    grammar* get_rs_grammar()
    {
        ...
        std::ifstream this_grammar_file("../RestorableScene/rs_lang_grammar.cpp");
...
gm::nt(L"CONSTANT_MAP_PAIR") >> gm::symlist{ gm::te(gm::ttype::l_left_curly_braces),
    ...
    >> RS_ASTBUILDER_INDEX(ast::pass_unary_op),
                ...
                gm::nt(L"CALLABLE_VALUE") >> gm::symlist{ gm::nt(L"MAY_REF_FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_direct), gm::nt(L"LEFTVARIABLE") }
    ...
    >> RS_ASTBUILDER_INDEX(ast::pass_token),
            ...
            if (!RS_GRAMMAR_SKIP_GEN_LR1_TABLE_CACHE)
            {
                ...
                // Do expe
                std::wofstream cachefile("../RestorableScene/rs_lang_grammar_lr1_autogen.hpp");
