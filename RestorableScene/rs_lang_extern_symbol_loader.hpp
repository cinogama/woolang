...
#   endif
    ...
    public:
        struct extern_lib_guard
        {
            ...
            rs_native_func load_func(const char* funcname)
            {
                if (extern_lib)
        ...
        struct extern_lib_set
        {
            ...
            rs_native_func try_load_func_from_in(
                const char* srcpath,
                const char* libpath,
                const char* funcname)
            {
        ...
        static rs_native_func get_lib_symbol(const char* src, const char* lib, const char* symb, extern_lib_set& elibs)
        {
