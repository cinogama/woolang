...
const char* color_for_token(wo_lspv2_lexer_token t)
{
    ...
    // Operators (arithmetic, assignment, comparison, logical, arrows): cyan.
    case WO_LSPV2_TOKEN_ADD:
    case WO_LSPV2_TOKEN_SUB:
    case WO_LSPV2_TOKEN_MUL:
    case WO_LSPV2_TOKEN_DIV:
    case WO_LSPV2_TOKEN_MOD:
    case WO_LSPV2_TOKEN_ASSIGN:
    case WO_LSPV2_TOKEN_ADD_ASSIGN:
    case WO_LSPV2_TOKEN_SUB_ASSIGN:
    case WO_LSPV2_TOKEN_MUL_ASSIGN:
    case WO_LSPV2_TOKEN_DIV_ASSIGN:
    case WO_LSPV2_TOKEN_MOD_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_ADD_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_SUB_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_MUL_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_DIV_ASSIGN:
    case WO_LSPV2_TOKEN_VALUE_MOD_ASSIGN:
    case WO_LSPV2_TOKEN_EQUAL:
    case WO_LSPV2_TOKEN_NOT_EQUAL:
    case WO_LSPV2_TOKEN_LARG_OR_EQUAL:
    case WO_LSPV2_TOKEN_LESS_OR_EQUAL:
    case WO_LSPV2_TOKEN_LESS:
    case WO_LSPV2_TOKEN_LARG:
    case WO_LSPV2_TOKEN_LAND:
    case WO_LSPV2_TOKEN_LOR:
    case WO_LSPV2_TOKEN_OR:
    case WO_LSPV2_TOKEN_LNOT:
    case WO_LSPV2_TOKEN_DIRECT:
    case WO_LSPV2_TOKEN_INV_DIRECT:
    case WO_LSPV2_TOKEN_FUNCTION_RESULT:
    case WO_LSPV2_TOKEN_BIND_MONAD:
    case WO_LSPV2_TOKEN_MAP_MONAD:
    case WO_LSPV2_TOKEN_QUESTION:
        return WOORT_ANSI_CLY;

    // Punctuation / delimiters: gray.
    case WO_LSPV2_TOKEN_SEMICOLON:
    case WO_LSPV2_TOKEN_COMMA:
    case WO_LSPV2_TOKEN_SCOPEING:
    case WO_LSPV2_TOKEN_TEMPLATE_USING_BEGIN:
    case WO_LSPV2_TOKEN_TYPECAST:
    case WO_LSPV2_TOKEN_INDEX_POINT:
    case WO_LSPV2_TOKEN_DOUBLE_INDEX_POINT:
    case WO_LSPV2_TOKEN_VARIADIC_SIGN:
    case WO_LSPV2_TOKEN_INDEX_BEGIN:
    case WO_LSPV2_TOKEN_INDEX_END:
    case WO_LSPV2_TOKEN_LEFT_BRACKETS:
    case WO_LSPV2_TOKEN_RIGHT_BRACKETS:
    case WO_LSPV2_TOKEN_LEFT_CURLY_BRACES:
    case WO_LSPV2_TOKEN_RIGHT_CURLY_BRACES:
        return WOORT_ANSI_GRY;
