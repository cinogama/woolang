    ...
    grammar *get_wo_grammar()
    {
        ...
        else
        {
            ...
            wo_grammar = new grammar({
                ...
                gm::nt(L"SINGLE_VALUE") >> gm::symlist{ gm::te(gm::ttype::l_mut), gm::nt(L"UNARIED_FACTOR") } >> WO_ASTBUILDER_INDEX(ast::pass_mark_mut),
                gm::nt(L"SINGLE_VALUE") >> gm::symlist{ gm::te(gm::ttype::l_immut), gm::nt(L"UNARIED_FACTOR") } >> WO_ASTBUILDER_INDEX(ast::pass_mark_immut),
