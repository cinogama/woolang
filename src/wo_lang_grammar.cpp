    ...
    grammar *get_wo_grammar()
    {
        ...
        else
        {
            ...
            wo_grammar = new grammar({
                ...
                gm::nt(L"FOREACH") >> gm::symlist{gm::te(gm::ttype::l_for), gm::te(gm::ttype::l_left_brackets), gm::te(gm::ttype::l_let), gm::nt(L"DEFINE_PATTERN"), gm::te(gm::ttype::l_typecast), gm::nt(L"EXPRESSION"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"BLOCKED_SENTENCE")} >> WO_ASTBUILDER_INDEX(ast::pass_foreach),
                ...
                gm::nt(L"VAR_DEFINE_LET_SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_let), gm::nt(L"VARDEFINES")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_attrib_for_varref_define),                                                              // ASTVariableDefination
                gm::nt(L"VARDEFINES") >> gm::symlist{ gm::nt(L"VARDEFINE") } >> WO_ASTBUILDER_INDEX(ast::pass_create_list<0>),  // ASTVariableDefination
                gm::nt(L"VARDEFINES") >> gm::symlist{
                    gm::nt(L"VARDEFINES"),
                    gm::te(gm::ttype::l_comma), 
                    gm::nt(L"VARDEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_append_list<2, 0>), // ASTVariableDefination
                gm::nt(L"VARDEFINE") >> gm::symlist{
                    gm::nt(L"DEFINE_PATTERN_MAY_TEMPLATE"), 
                    gm::te(gm::ttype::l_assign), 
                    gm::nt(L"EXPRESSION")} >> WO_ASTBUILDER_INDEX(ast::pass_variable_define_item),  // ASTVariableDefination
                ...
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_mul), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_operation),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_div), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_operation),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_mod), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_operation),
                ...
                gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY") >> gm::symlist{ gm::nt(L"DEFINE_TEMPLATE_ITEM") } >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                ...
                gm::nt(L"DECL_UNION") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_union), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY"), gm::te(gm::ttype::l_left_curly_braces), gm::nt(L"UNION_ITEMS"), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_union_declare),
                ...
                gm::nt(L"DEFINE_PATTERN_WITH_TEMPLATE") >> gm::symlist{
                    gm::nt(L"IDENTIFIER"),
                    gm::nt(L"DEFINE_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_pattern_identifier_or_takepace_with_template),
                gm::nt(L"DEFINE_PATTERN_WITH_TEMPLATE") >> gm::symlist{
                    gm::te(gm::ttype::l_mut), 
                    gm::nt(L"IDENTIFIER"),
                    gm::nt(L"DEFINE_TEMPLATE_ITEM") } >> WO_ASTBUILDER_INDEX(ast::pass_pattern_mut_identifier_or_takepace_with_template),
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{
                    gm::te(gm::ttype::l_left_brackets), 
                    gm::nt(L"DEFINE_PATTERN_LIST"), 
                    gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_pattern_tuple),
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{
                    gm::te(gm::ttype::l_left_brackets), 
