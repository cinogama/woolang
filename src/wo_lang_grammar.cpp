...
namespace wo
{
    ...
    grammar* get_wo_grammar()
    {
        ...
        if (WO_LANG_GRAMMAR_CRC64 == wo_lang_grammar_crc64 || wo::config::ENABLE_CHECK_GRAMMAR_AND_UPDATE == false)
        {
        load_from_buffer:
            ...
            wo_grammar = new grammar(
                {
                    ...
                    gm::nt(L"SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), // useless
                                                       gm::te(gm::ttype::l_using), gm::nt(L"LEFTVARIABLE"), gm::te(gm::ttype::l_semicolon)} >>
                        WO_ASTBUILDER_INDEX(ast::pass_using_namespace),
                    gm::nt(L"SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_using), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_assign), gm::nt(L"TYPE"), gm::nt(L"SENTENCE_BLOCK_MAY_SEMICOLON")} >> WO_ASTBUILDER_INDEX(ast::pass_using_type_as),
                    ...
                    gm::nt(L"SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_alias), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_assign), gm::nt(L"TYPE"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_using_type_as),
                //////////////////////////////////////////////////////////////////////////////////////
                gm::nt(L"IMPORT_IDENTIFIER") >> gm::symlist{gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_token),
                gm::nt(L"IMPORT_NAME") >> gm::symlist{gm::nt(L"IMPORT_IDENTIFIER"), gm::nt(L"INDEX_IMPORT_NAME")} >> WO_ASTBUILDER_INDEX(ast::pass_append_list<0, 1>),
                gm::nt(L"INDEX_IMPORT_NAME") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_create_list<0>),
                gm::nt(L"INDEX_IMPORT_NAME") >> gm::symlist{gm::te(gm::ttype::l_scopeing), gm::nt(L"IMPORT_IDENTIFIER"), gm::nt(L"INDEX_IMPORT_NAME")} >> WO_ASTBUILDER_INDEX(ast::pass_append_list<1, 2>),
                ...
                gm::nt(L"ENUM_ITEM_LIST") >> gm::symlist{gm::nt(L"ENUM_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_enum_declear_begin),
                gm::nt(L"ENUM_ITEM_LIST") >> gm::symlist{gm::nt(L"ENUM_ITEM_LIST"), gm::te(gm::ttype::l_comma), gm::nt(L"ENUM_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_enum_declear_append),
                gm::nt(L"ENUM_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_enum_item_create),
                gm::nt(L"ENUM_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_assign), gm::te(gm::ttype::l_literal_integer)} >> WO_ASTBUILDER_INDEX(ast::pass_enum_item_create),
                gm::nt(L"ENUM_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_assign), gm::te(gm::ttype::l_add), gm::te(gm::ttype::l_literal_integer)} >> WO_ASTBUILDER_INDEX(ast::pass_enum_item_create),
                gm::nt(L"ENUM_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_assign), gm::te(gm::ttype::l_sub), gm::te(gm::ttype::l_literal_integer)} >> WO_ASTBUILDER_INDEX(ast::pass_enum_item_create),
                ...
                gm::nt(L"SENTENCE_BLOCK") >> gm::symlist{gm::te(gm::ttype::l_left_curly_braces), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_empty_sentence_block),
                ...
                gm::nt(L"DECL_ATTRIBUTE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE_ITEMS")} >> WO_ASTBUILDER_INDEX(ast::pass_decl_attrib_check),
                gm::nt(L"DECL_ATTRIBUTE") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_decl_attrib_begin),
                gm::nt(L"DECL_ATTRIBUTE_ITEMS") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_decl_attrib_begin),
                gm::nt(L"DECL_ATTRIBUTE_ITEMS") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE_ITEMS"), gm::nt(L"DECL_ATTRIBUTE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_append_attrib),
                ...
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR_MAY_EMPTY"), gm::nt(L"WHERE_CONSTRAINT_WITH_SEMICOLON"), gm::nt(L"SENTENCE_BLOCK")} >> WO_ASTBUILDER_INDEX(ast::pass_function_define),
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::te(gm::ttype::l_operator), gm::nt(L"OVERLOADINGABLE_OPERATOR"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR_MAY_EMPTY"), gm::nt(L"WHERE_CONSTRAINT_WITH_SEMICOLON"), gm::nt(L"SENTENCE_BLOCK")} >> WO_ASTBUILDER_INDEX(ast::pass_function_define),
                ...
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"EXTERN_FROM"), gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR"), gm::nt(L"WHERE_CONSTRAINT_MAY_EMPTY"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_function_define),
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"EXTERN_FROM"), gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::te(gm::ttype::l_operator), gm::nt(L"OVERLOADINGABLE_OPERATOR"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR"), gm::nt(L"WHERE_CONSTRAINT_MAY_EMPTY"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_function_define),
                ...
                gm::nt(L"FORLOOP") >> gm::symlist{gm::te(gm::ttype::l_for), gm::te(gm::ttype::l_left_brackets), gm::nt(L"VAR_DEFINE_WITH_SEMICOLON"), gm::nt(L"MAY_EMPTY_EXPRESSION"), gm::te(gm::ttype::l_semicolon), gm::nt(L"MAY_EMPTY_EXPRESSION"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"BLOCKED_SENTENCE")} >> WO_ASTBUILDER_INDEX(ast::pass_forloop),
                gm::nt(L"FORLOOP") >> gm::symlist{gm::te(gm::ttype::l_for), gm::te(gm::ttype::l_left_brackets), gm::nt(L"MAY_EMPTY_EXPRESSION"), gm::te(gm::ttype::l_semicolon), gm::nt(L"MAY_EMPTY_EXPRESSION"), gm::te(gm::ttype::l_semicolon), gm::nt(L"MAY_EMPTY_EXPRESSION"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"BLOCKED_SENTENCE")} >> WO_ASTBUILDER_INDEX(ast::pass_forloop),
                ...
                gm::nt(L"SENTENCE") >> gm::symlist{gm::te(gm::ttype::l_break), gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_break),
                gm::nt(L"SENTENCE") >> gm::symlist{gm::te(gm::ttype::l_continue), gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_continue),
                ...
                gm::nt(L"VAR_DEFINE_LET_SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_let), gm::nt(L"VARDEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_as_var_define), // ASTVariableDefination
                gm::nt(L"VARDEFINE") >> gm::symlist{gm::nt(L"DEFINE_PATTERN"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_assign), gm::nt(L"EXPRESSION")} >> WO_ASTBUILDER_INDEX(ast::pass_begin_varref_define), // ASTVariableDefination
                gm::nt(L"VARDEFINE") >> gm::symlist{gm::nt(L"VARDEFINE"), gm::te(gm::ttype::l_comma), gm::nt(L"DEFINE_PATTERN"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_assign), gm::nt(L"EXPRESSION")} >> WO_ASTBUILDER_INDEX(ast::pass_add_varref_define), // ASTVariableDefination
                gm::nt(L"SENTENCE") >> gm::symlist{gm::te(gm::ttype::l_return), gm::nt(L"RETNVALUE"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_return),
                gm::nt(L"RETNVALUE") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                gm::nt(L"RETNVALUE") >> gm::symlist{gm::nt(L"MAY_MUT_PURE_VALUE")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                ...
                gm::nt(L"RIGHT") >> gm::symlist{gm::te(gm::ttype::l_do), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_do_expr_as_sentence),
                gm::nt(L"RIGHT") >> gm::symlist{gm::nt(L"ASSIGNMENT")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_add_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_sub_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_mul_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_div_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_mod_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_add_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_sub_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_mul_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_div_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                gm::nt(L"ASSIGNMENT") >> gm::symlist{gm::nt(L"LEFT"), gm::te(gm::ttype::l_value_mod_assign), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_assign_op),
                ...
                gm::nt(L"MAY_MUT_PURE_TRI_EXPR") >> gm::symlist{gm::te(gm::ttype::l_mut), gm::nt(L"TRI_EXPR")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_value_as_mut),
                gm::nt(L"MAY_MUT_PURE_TRI_EXPR") >> gm::symlist{gm::te(gm::ttype::l_immut), gm::nt(L"TRI_EXPR")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_value_as_mut),
                gm::nt(L"MAY_MUT_PURE_TRI_EXPR") >> gm::symlist{gm::nt(L"TRI_EXPR")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"TRI_EXPR") >> gm::symlist{gm::nt(L"TRI_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"TRI_EXPR") >> gm::symlist{gm::nt(L"TRI_ITEM"), gm::te(gm::ttype::l_question), gm::nt(L"MAY_MUT_PURE_TRI_EXPR"), gm::te(gm::ttype::l_or), gm::nt(L"MAY_MUT_PURE_TRI_EXPR")} >> WO_ASTBUILDER_INDEX(ast::pass_trib_expr),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FUNC_DEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"FUNC_DEFINE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), // In fact, it was useless, just for avoiding lr1-short-cut
                                                      gm::te(gm::ttype::l_func), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR_MAY_EMPTY"), gm::nt(L"WHERE_CONSTRAINT_WITH_SEMICOLON"), gm::nt(L"SENTENCE_BLOCK")} >>
                ...
                gm::nt(L"WHERE_DECL_FOR_LAMBDA") >> gm::symlist{gm::te(gm::ttype::l_where), gm::nt(L"VARDEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_trans_where_decl_in_lambda),
                ...
                gm::nt(L"RETURN_EXPR_IN_LAMBDA") >> gm::symlist{gm::nt(L"MAY_MUT_PURE_VALUE")} >> WO_ASTBUILDER_INDEX(ast::pass_return),
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                gm::nt(L"ORIGIN_TYPE") >> gm::symlist{gm::nt(L"TUPLE_TYPE_LIST")} >> WO_ASTBUILDER_INDEX(ast::pass_build_tuple_type),
                gm::nt(L"TUPLE_TYPE_LIST") >> gm::symlist{gm::te(gm::ttype::l_left_brackets), gm::nt(L"TUPLE_TYPE_LIST_ITEMS"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_tuple_types_list),
                gm::nt(L"TUPLE_TYPE_LIST") >> gm::symlist{gm::te(gm::ttype::l_left_brackets), gm::nt(L"TUPLE_TYPE_LIST_ITEMS"), gm::te(gm::ttype::l_comma), gm::nt(L"VARIADIC_MAY_EMPTY"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_tuple_types_list),
                gm::nt(L"TUPLE_TYPE_LIST_ITEMS") >> gm::symlist{gm::nt(L"VARIADIC_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_create_list<0>),
                ...
                gm::nt(L"TYPE") >> gm::symlist{gm::te(gm::ttype::l_mut), gm::nt(L"ORIGIN_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_build_mutable_type),
                gm::nt(L"TYPE") >> gm::symlist{gm::te(gm::ttype::l_immut), gm::nt(L"ORIGIN_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_build_mutable_type),
                gm::nt(L"ORIGIN_TYPE") >> gm::symlist{gm::nt(L"TYPEOF")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                ...
                gm::nt(L"ORIGIN_TYPE") >> gm::symlist{gm::nt(L"LEFTVARIABLE"), gm::nt(L"MAY_EMPTY_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_build_type_may_template),
                gm::nt(L"ORIGIN_TYPE") >> gm::symlist{gm::te(gm::ttype::l_nil)} >> WO_ASTBUILDER_INDEX(ast::pass_build_nil_type),
                ...
                gm::nt(L"ARGDEFINE_VAR_ITEM") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::nt(L"IDENTIFIER"), gm::nt(L"TYPE_DECL_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_func_argument),
                gm::nt(L"ARGDEFINE_VAR_ITEM") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_mut), gm::nt(L"IDENTIFIER"), gm::nt(L"TYPE_DECL_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_func_argument),
                ...
                gm::nt(L"LOGICAL_OR") >> gm::symlist{gm::nt(L"LOGICAL_OR"), gm::te(gm::ttype::l_lor), gm::nt(L"LOGICAL_AND")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"LOGICAL_AND") >> gm::symlist{gm::nt(L"EQUATION")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"LOGICAL_AND") >> gm::symlist{gm::nt(L"LOGICAL_AND"), gm::te(gm::ttype::l_land), gm::nt(L"EQUATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"EQUATION") >> gm::symlist{gm::nt(L"RELATION")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"EQUATION") >> gm::symlist{gm::nt(L"EQUATION"), gm::te(gm::ttype::l_equal), gm::nt(L"RELATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"EQUATION") >> gm::symlist{gm::nt(L"EQUATION"), gm::te(gm::ttype::l_not_equal), gm::nt(L"RELATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"RELATION") >> gm::symlist{gm::nt(L"SUMMATION")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"RELATION") >> gm::symlist{gm::nt(L"RELATION"), gm::te(gm::ttype::l_larg), gm::nt(L"SUMMATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"RELATION") >> gm::symlist{gm::nt(L"RELATION"), gm::te(gm::ttype::l_less), gm::nt(L"SUMMATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"RELATION") >> gm::symlist{gm::nt(L"RELATION"), gm::te(gm::ttype::l_less_or_equal), gm::nt(L"SUMMATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"RELATION") >> gm::symlist{gm::nt(L"RELATION"), gm::te(gm::ttype::l_larg_or_equal), gm::nt(L"SUMMATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_logical_op),
                gm::nt(L"SUMMATION") >> gm::symlist{gm::nt(L"MULTIPLICATION")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"SUMMATION") >> gm::symlist{gm::nt(L"SUMMATION"), gm::te(gm::ttype::l_add), gm::nt(L"MULTIPLICATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_op),
                gm::nt(L"SUMMATION") >> gm::symlist{gm::nt(L"SUMMATION"), gm::te(gm::ttype::l_sub), gm::nt(L"MULTIPLICATION")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_op),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_mul), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_op),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_div), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_op),
                gm::nt(L"MULTIPLICATION") >> gm::symlist{gm::nt(L"MULTIPLICATION"), gm::te(gm::ttype::l_mod), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_binary_op),
                gm::nt(L"UNARIED_FACTOR") >> gm::symlist{gm::nt(L"SINGLE_VALUE")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"SINGLE_VALUE") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"FACTOR_TYPE_CASTING") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::nt(L"AS_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_type_judgement),
                gm::nt(L"FACTOR_TYPE_CASTING") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::nt(L"IS_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_type_check),
                ...
                // TYPE CASTING..
                gm::nt(L"FACTOR_TYPE_CASTING") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::nt(L"TYPE_DECLEAR")} >> WO_ASTBUILDER_INDEX(ast::pass_type_cast),
                ...
                gm::nt(L"UNIT") >> gm::symlist{gm::te(gm::ttype::l_literal_char)} >> WO_ASTBUILDER_INDEX(ast::pass_literal),
                ...
                gm::nt(L"FORMAT_STRING") >> gm::symlist{gm::te(gm::ttype::l_format_string_begin), gm::nt(L"FORMAT_STRING_LIST"), gm::te(gm::ttype::l_format_string_end)} >> WO_ASTBUILDER_INDEX(ast::pass_finish_format_string),
                gm::nt(L"FORMAT_STRING_LIST") >> gm::symlist{gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_format_string),
                gm::nt(L"FORMAT_STRING_LIST") >> gm::symlist{gm::nt(L"FORMAT_STRING_LIST"), gm::te(gm::ttype::l_format_string), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_format_string),
                ...
                gm::nt(L"CONSTANT_ARRAY") >> gm::symlist{gm::te(gm::ttype::l_index_begin), gm::nt(L"CONSTANT_ARRAY_ITEMS"), gm::te(gm::ttype::l_index_end)} >> WO_ASTBUILDER_INDEX(ast::pass_array_builder),
                ...
                //////////////////////
                gm::nt(L"UNIT") >> gm::symlist{gm::nt(L"CONSTANT_TUPLE")} >> WO_ASTBUILDER_INDEX(ast::pass_make_tuple),
                gm::nt(L"CONSTANT_TUPLE") >> gm::symlist{gm::te(gm::ttype::l_left_brackets), gm::nt(L"COMMA_MAY_EMPTY"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                ...
                ///////////////////////
                gm::nt(L"CONSTANT_MAP") >> gm::symlist{gm::te(gm::ttype::l_left_curly_braces), gm::nt(L"CONSTANT_MAP_PAIRS"), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_map_builder),
                ...
                gm::nt(L"CONSTANT_MAP_PAIR") >> gm::symlist{gm::nt(L"CONSTANT_ARRAY"), gm::te(gm::ttype::l_assign), gm::nt(L"MAY_MUT_PURE_VALUE")} >> WO_ASTBUILDER_INDEX(ast::pass_mapping_pair),
                gm::nt(L"UNARIED_FACTOR") >> gm::symlist{gm::te(gm::ttype::l_sub), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_unary_op),
                gm::nt(L"UNARIED_FACTOR") >> gm::symlist{gm::te(gm::ttype::l_lnot), gm::nt(L"UNARIED_FACTOR")} >> WO_ASTBUILDER_INDEX(ast::pass_unary_op),
                gm::nt(L"LEFT") >> gm::symlist{gm::nt(L"CALLABLE_LEFT")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"CALLABLE_LEFT") >> gm::symlist{gm::nt(L"LEFTVARIABLE"), gm::nt(L"MAY_EMPTY_LEFT_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_template_reification),
                ...
                gm::nt(L"LEFTVARIABLE") >> gm::symlist{gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_variable),
                gm::nt(L"LEFTVARIABLE") >> gm::symlist{gm::nt(L"SCOPING_IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"SCOPING_IDENTIFIER") >> gm::symlist{gm::nt(L"SCOPING_BEGIN_IDENT"), gm::nt(L"SCOPING_LIST")} >> WO_ASTBUILDER_INDEX(ast::pass_finalize_serching_namespace),
                gm::nt(L"SCOPING_BEGIN_IDENT") >> gm::symlist{gm::nt(L"TYPEOF")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"SCOPING_BEGIN_IDENT") >> gm::symlist{gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"SCOPING_BEGIN_IDENT") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                gm::nt(L"SCOPING_LIST") >> gm::symlist{gm::te(gm::ttype::l_scopeing), gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_variable_in_namespace), // TODO HERE SHOULD BE IDENTIF IN NAMESPACE
                gm::nt(L"SCOPING_LIST") >> gm::symlist{gm::te(gm::ttype::l_scopeing), gm::nt(L"IDENTIFIER"), gm::nt(L"SCOPING_LIST")} >> WO_ASTBUILDER_INDEX(ast::pass_append_serching_namespace),
                gm::nt(L"LEFT") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_index_point), gm::nt(L"INDEX_POINT_TARGET")} >> WO_ASTBUILDER_INDEX(ast::pass_index_op),
                ...
                gm::nt(L"LEFT") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_index_begin), gm::nt(L"RIGHT"), gm::te(gm::ttype::l_index_end)} >> WO_ASTBUILDER_INDEX(ast::pass_index_op),
                ...
                gm::nt(L"DIRECT_CALLABLE_VALUE") >> gm::symlist{gm::nt(L"DIRECT_CALL_FIRST_ARG"), gm::te(gm::ttype::l_direct), gm::nt(L"DIRECT_CALLABLE_TARGET")} >> WO_ASTBUILDER_INDEX(ast::pass_directed_value_for_call),
                ...
                // MONAD GRAMMAR~~~ SUGAR!
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_bind_monad), gm::nt(L"CALLABLE_LEFT")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_bind_monad), gm::nt(L"CALLABLE_RIGHT_WITH_BRACKET")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_bind_monad), gm::nt(L"FUNC_DEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_map_monad), gm::nt(L"CALLABLE_LEFT")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_map_monad), gm::nt(L"CALLABLE_RIGHT_WITH_BRACKET")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                gm::nt(L"FACTOR") >> gm::symlist{gm::nt(L"FACTOR_TYPE_CASTING"), gm::te(gm::ttype::l_map_monad), gm::nt(L"FUNC_DEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_build_bind_map_monad),
                ...
                gm::nt(L"FUNCTION_CALL") >> gm::symlist{gm::nt(L"FACTOR"), gm::nt(L"ARGUMENT_LISTS")} >> WO_ASTBUILDER_INDEX(ast::pass_function_call),
                gm::nt(L"FUNCTION_CALL") >> gm::symlist{gm::nt(L"DIRECT_CALLABLE_VALUE"), gm::nt(L"ARGUMENT_LISTS_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_function_call),
                ...
                gm::nt(L"INV_FUNCTION_CALL") >> gm::symlist{gm::nt(L"FUNCTION_CALL"), gm::te(gm::ttype::l_inv_direct), gm::nt(L"INV_DIRECT_CALL_FIRST_ARG")} >> WO_ASTBUILDER_INDEX(ast::pass_function_inv_call),
                gm::nt(L"INV_FUNCTION_CALL") >> gm::symlist{gm::nt(L"DIRECT_CALLABLE_TARGET"), gm::te(gm::ttype::l_inv_direct), gm::nt(L"INV_DIRECT_CALL_FIRST_ARG")} >> WO_ASTBUILDER_INDEX(ast::pass_function_inv_call2),
                ...
                gm::nt(L"MAY_MUT_PURE_VALUE") >> gm::symlist{gm::te(gm::ttype::l_mut), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_value_as_mut),
                gm::nt(L"MAY_MUT_PURE_VALUE") >> gm::symlist{gm::te(gm::ttype::l_immut), gm::nt(L"RIGHT")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_value_as_mut),
                ...
                gm::nt(L"LEFT_TEMPLATE_ITEM") >> gm::symlist{gm::te(gm::ttype::l_template_using_begin), gm::nt(L"TEMPLATE_TYPE_LIST"), gm::te(gm::ttype::l_larg)} >> WO_ASTBUILDER_INDEX(ast::pass_direct<1>),
                gm::nt(L"TYPE_TEMPLATE_ITEM") >> gm::symlist{gm::te(gm::ttype::l_less), gm::nt(L"TEMPLATE_TYPE_LIST"), gm::te(gm::ttype::l_larg)} >> WO_ASTBUILDER_INDEX(ast::pass_direct<1>),
                ...
                gm::nt(L"TEMPLATE_TYPE_LIST") >> gm::symlist{gm::nt(L"TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_create_list<0>),
                gm::nt(L"TEMPLATE_TYPE_LIST") >> gm::symlist{gm::nt(L"TEMPLATE_TYPE_LIST"), gm::te(gm::ttype::l_comma), gm::nt(L"TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_append_list<2, 0>),
                gm::nt(L"DEFINE_TEMPLATE_ITEM") >> gm::symlist{gm::te(gm::ttype::l_empty)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                gm::nt(L"DEFINE_TEMPLATE_ITEM") >> gm::symlist{gm::te(gm::ttype::l_less), gm::nt(L"DEFINE_TEMPLATE_TYPE_LIST"), gm::te(gm::ttype::l_larg)} >> WO_ASTBUILDER_INDEX(ast::pass_direct<1>),
                gm::nt(L"DEFINE_TEMPLATE_TYPE_LIST") >> gm::symlist{gm::nt(L"DEFINE_TEMPLATE_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_create_list<0>),
                gm::nt(L"DEFINE_TEMPLATE_TYPE_LIST") >> gm::symlist{gm::nt(L"DEFINE_TEMPLATE_TYPE_LIST"), gm::te(gm::ttype::l_comma), gm::nt(L"DEFINE_TEMPLATE_TYPE")} >> WO_ASTBUILDER_INDEX(ast::pass_append_list<2, 0>),
                gm::nt(L"DEFINE_TEMPLATE_TYPE") >> gm::symlist{gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_template_decl),
                gm::nt(L"SENTENCE") >> gm::symlist{gm::nt(L"DECL_UNION")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"DECL_UNION") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_union), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM"), gm::te(gm::ttype::l_left_curly_braces), gm::nt(L"UNION_ITEMS"), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_union_define),
                ...
                gm::nt(L"UNION_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::nt(L"TYPE_DECL_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_union_item),
                gm::nt(L"UNION_ITEM") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"TYPE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"TYPE_DECL_MAY_EMPTY")} >> WO_ASTBUILDER_INDEX(ast::pass_union_item),
                ...
                gm::nt(L"MATCH_CASE") >> gm::symlist{gm::nt(L"PATTERN_UNION_CASE"), gm::te(gm::ttype::l_question), gm::nt(L"BLOCKED_SENTENCE")} >> WO_ASTBUILDER_INDEX(ast::pass_match_case_for_union),
                // PATTERN-CASE MAY BE A SINGLE-VARIABLE/TUPLE/STRUCT...
                gm::nt(L"PATTERN_UNION_CASE") >> gm::symlist{gm::nt(L"CALLABLE_LEFT")} >> WO_ASTBUILDER_INDEX(ast::pass_union_pattern),
                // PATTERN-CASE MAY BE A UNION
                gm::nt(L"PATTERN_UNION_CASE") >> gm::symlist{gm::nt(L"CALLABLE_LEFT"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"DEFINE_PATTERN"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_union_pattern),
                //////////////////////////////////////////////////////////////////////////////////////
                gm::nt(L"ORIGIN_TYPE") >> gm::symlist{
                ...
                gm::nt(L"STRUCT_MEMBER_PAIR") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::nt(L"TYPE_DECLEAR")} >> WO_ASTBUILDER_INDEX(ast::pass_struct_member_def),
                gm::nt(L"STRUCT_MEMBER_PAIR") >> gm::symlist{gm::nt(L"ACCESS_MODIFIER"), gm::nt(L"IDENTIFIER"), gm::nt(L"TYPE_DECLEAR")} >> WO_ASTBUILDER_INDEX(ast::pass_struct_member_def),
                ////////////////////////////////////////////////////////
                gm::nt(L"UNIT") >> gm::symlist{
                                       gm::nt(L"STRUCT_TYPE"), // Here we use Callable left stand for type. so we cannot support x here...
                                       gm::te(gm::ttype::l_left_curly_braces),
                                       gm::nt(L"STRUCT_MEMBER_INITS"),
                                       gm::te(gm::ttype::l_right_curly_braces),
                                   } >>
                    WO_ASTBUILDER_INDEX(ast::pass_make_struct_instance),
                gm::nt(L"STRUCT_TYPE") >> gm::symlist{gm::nt(L"LEFTVARIABLE"), gm::nt(L"MAY_EMPTY_LEFT_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_build_type_may_template), // We should parse LEFT to type here. it's very easy!
                gm::nt(L"STRUCT_TYPE") >> gm::symlist{gm::nt(L"TYPEOF")} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                gm::nt(L"STRUCT_TYPE") >> gm::symlist{gm::te(gm::ttype::l_struct)} >> WO_ASTBUILDER_INDEX(ast::pass_direct<0>),
                ...
                ////////////////////////////////////////////////////
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_identifier_pattern),
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{gm::te(gm::ttype::l_mut), gm::nt(L"DECL_ATTRIBUTE"), gm::nt(L"IDENTIFIER")} >> WO_ASTBUILDER_INDEX(ast::pass_identifier_pattern),
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{gm::te(gm::ttype::l_left_brackets), gm::nt(L"DEFINE_PATTERN_LIST"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_tuple_pattern),
                gm::nt(L"DEFINE_PATTERN") >> gm::symlist{gm::te(gm::ttype::l_left_brackets), gm::nt(L"COMMA_MAY_EMPTY"), gm::te(gm::ttype::l_right_brackets)} >> WO_ASTBUILDER_INDEX(ast::pass_tuple_pattern),
