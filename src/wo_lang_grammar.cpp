        ...
        else
        {
            ...
            wo_grammar = new grammar(
                ...
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{
                    ...
                    gm::nt(L"RETURN_TYPE_DECLEAR_MAY_EMPTY"), 
                    gm::nt(L"WHERE_CONSTRAINT_WITH_SEMICOLON"), 
                    gm::nt(L"SENTENCE_BLOCK")} >> WO_ASTBUILDER_INDEX(ast::pass_func_def_oper),
                ...
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{
                    ...
                    gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_def_extn),
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{
                    gm::nt(L"EXTERN_FROM"), 
                    gm::nt(L"DECL_ATTRIBUTE"), 
                    gm::te(gm::ttype::l_func), 
                    ...
                    gm::nt(L"RETURN_TYPE_DECLEAR"), 
                    gm::nt(L"WHERE_CONSTRAINT_MAY_EMPTY"), 
                    gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_def_extn_oper),
                ...
                gm::nt(L"VAR_DEFINE_LET_SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_let), gm::nt(L"VARDEFINE")} >> WO_ASTBUILDER_INDEX(ast::pass_mark_attrib_for_varref_define), // ASTVariableDefination
                ...
                gm::nt(L"FUNC_DEFINE") >> gm::symlist{
                    ...
                    gm::nt(L"RETURN_TYPE_DECLEAR_MAY_EMPTY"), 
                    gm::nt(L"WHERE_CONSTRAINT_WITH_SEMICOLON"), 
                    gm::nt(L"SENTENCE_BLOCK")} >> WO_ASTBUILDER_INDEX(ast::pass_func_lambda_ml),
                gm::nt(L"FUNC_DEFINE") >> gm::symlist{
                    ...
                    gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_lambda),
                // May empty
                ...
                //////////////////////////////////////////////////////////////////////////////////////
                gm::nt(L"ASTTOKEN_IDENTIFER") >> gm::symlist{ gm::nt(L"IDENTIFIER") } >> WO_ASTBUILDER_INDEX(ast::pass_token),
