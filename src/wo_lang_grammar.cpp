    ...
    grammar *get_wo_grammar()
    {
        ...
        else
        {
            ...
            wo_grammar = new grammar({
                ...
                gm::nt(L"SENTENCE") >> gm::symlist{gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_alias), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY"), gm::te(gm::ttype::l_assign), gm::nt(L"TYPE"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_alias_type_as),
                //////////////////////////////////////////////////////////////////////////////////////
                ...
                gm::nt(L"DECL_NAMESPACE") >> gm::symlist{
                    gm::te(gm::ttype::l_namespace),
                    gm::nt(L"SPACE_NAME_LIST"), 
                    gm::nt(L"SENTENCE_BLOCK")} >> WO_ASTBUILDER_INDEX(ast::pass_namespace),
                ...
                gm::nt(L"SENTENCE_BLOCK") >> gm::symlist{
                    gm::te(gm::ttype::l_left_curly_braces), gm::nt(L"PARAGRAPH"), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_sentence_block<1>),
                ...
                gm::nt(L"SENTENCE_BLOCK") >> gm::symlist{
                    gm::te(gm::ttype::l_left_curly_braces), gm::te(gm::ttype::l_right_curly_braces)} >> WO_ASTBUILDER_INDEX(ast::pass_empty),
                ...
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"EXTERN_FROM"), gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::nt(L"AST_TOKEN_IDENTIFER"), gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR"), gm::nt(L"WHERE_CONSTRAINT_MAY_EMPTY"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_def_extn),
                gm::nt(L"FUNC_DEFINE_WITH_NAME") >> gm::symlist{gm::nt(L"EXTERN_FROM"), gm::nt(L"DECL_ATTRIBUTE"), gm::te(gm::ttype::l_func), gm::te(gm::ttype::l_operator), gm::nt(L"OVERLOADINGABLE_OPERATOR"), gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY"), gm::te(gm::ttype::l_left_brackets), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_right_brackets), gm::nt(L"RETURN_TYPE_DECLEAR"), gm::nt(L"WHERE_CONSTRAINT_MAY_EMPTY"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_def_extn_oper),
                ...
                gm::nt(L"FUNC_DEFINE") >> gm::symlist{gm::te(gm::ttype::l_lambda), gm::nt(L"DEFINE_TEMPLATE_ITEM_MAY_EMPTY"), gm::nt(L"ARGDEFINE"), gm::te(gm::ttype::l_assign), gm::nt(L"RETURN_EXPR_BLOCK_IN_LAMBDA"), gm::nt(L"WHERE_DECL_FOR_LAMBDA"), gm::te(gm::ttype::l_semicolon)} >> WO_ASTBUILDER_INDEX(ast::pass_func_lambda),
                // May empty
                ...
                gm::nt(L"DEFINE_PATTERN_WITH_TEMPLATE") >> gm::symlist{gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_pattern_identifier_or_takepace_with_template),
                gm::nt(L"DEFINE_PATTERN_WITH_TEMPLATE") >> gm::symlist{gm::te(gm::ttype::l_mut), gm::nt(L"IDENTIFIER"), gm::nt(L"DEFINE_TEMPLATE_ITEM")} >> WO_ASTBUILDER_INDEX(ast::pass_pattern_mut_identifier_or_takepace_with_template),
