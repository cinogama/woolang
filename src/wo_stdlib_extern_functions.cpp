...
namespace wo
{
    void rslib_extern_symbols::init_wo_lib()
    {
        ...
        wo_extern_lib_func_t funcs[] = {
            {"rslib_std_return_itself", rslib_std_return_itself},
            {"rslib_std_get_extern_symb", rslib_std_get_extern_symb},
            {"rslib_std_halt", rslib_std_halt},
            {"rslib_std_panic", rslib_std_panic},
            {"rslib_std_bad_function", rslib_std_bad_function},
            {"rslib_std_bit_or", rslib_std_bit_or},
            {"rslib_std_bit_and", rslib_std_bit_and},
            {"rslib_std_bit_xor", rslib_std_bit_xor},
            {"rslib_std_bit_not", rslib_std_bit_not},
            {"rslib_std_bit_shl", rslib_std_bit_shl},
            {"rslib_std_bit_shr", rslib_std_bit_shr},
            {"rslib_std_bit_ashr", rslib_std_bit_ashr},
            {"rslib_std_weakref_create", rslib_std_weakref_create},
            {"rslib_std_weakref_trylock", rslib_std_weakref_trylock},
            {"rslib_std_print", rslib_std_print},
            {"rslib_std_time_sec", rslib_std_time_sec},
            {"rslib_std_input_readint", rslib_std_input_readint},
            {"rslib_std_input_readreal", rslib_std_input_readreal},
            {"rslib_std_input_readstring", rslib_std_input_readstring},
            {"rslib_std_input_readline", rslib_std_input_readline},
            {"rslib_std_randomint", rslib_std_randomint},
            {"rslib_std_randomreal", rslib_std_randomreal},
            {"rslib_std_break_yield", rslib_std_break_yield},
            {"rslib_std_thread_sleep", rslib_std_thread_sleep},
            {"rslib_std_get_args", rslib_std_get_args},
            {"rslib_std_get_exe_path", rslib_std_get_exe_path},
            {"rslib_std_equal_byte", rslib_std_equal_byte},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_char_tostring", rslib_std_char_tostring},
            {"rslib_std_char_toupper", rslib_std_char_toupper},
            {"rslib_std_char_tolower", rslib_std_char_tolower},
            {"rslib_std_char_isspace", rslib_std_char_isspace},
            {"rslib_std_char_isalpha", rslib_std_char_isalpha},
            {"rslib_std_char_isalnum", rslib_std_char_isalnum},
            {"rslib_std_char_isnumber", rslib_std_char_isnumber},
            {"rslib_std_char_ishex", rslib_std_char_ishex},
            {"rslib_std_char_isoct", rslib_std_char_isoct},
            {"rslib_std_char_hexnum", rslib_std_char_hexnum},
            {"rslib_std_take_token", rslib_std_take_token},
            {"rslib_std_take_string", rslib_std_take_string},
            {"rslib_std_take_int", rslib_std_take_int},
            {"rslib_std_take_real", rslib_std_take_real},
            {"rslib_std_create_wchars_from_str", rslib_std_create_wchars_from_str},
            {"rslib_std_create_chars_from_str", rslib_std_create_chars_from_str},
            {"rslib_std_get_ascii_val_from_str", rslib_std_get_ascii_val_from_str},
            {"rslib_std_lengthof", rslib_std_lengthof},
            {"rslib_std_str_bytelen", rslib_std_str_bytelen},
            {"rslib_std_string_sub", rslib_std_string_sub},
            {"rslib_std_string_subto", rslib_std_string_subto},
            {"rslib_std_string_toupper", rslib_std_string_toupper},
            {"rslib_std_string_tolower", rslib_std_string_tolower},
            {"rslib_std_string_isspace", rslib_std_string_isspace},
            {"rslib_std_string_isalpha", rslib_std_string_isalpha},
            {"rslib_std_string_isalnum", rslib_std_string_isalnum},
            {"rslib_std_string_isnumber", rslib_std_string_isnumber},
            {"rslib_std_string_ishex", rslib_std_string_ishex},
            {"rslib_std_string_isoct", rslib_std_string_isoct},
            {"rslib_std_string_enstring", rslib_std_string_enstring},
            {"rslib_std_string_destring", rslib_std_string_destring},
            {"rslib_std_string_beginwith", rslib_std_string_beginwith},
            {"rslib_std_string_endwith", rslib_std_string_endwith},
            {"rslib_std_string_replace", rslib_std_string_replace},
            {"rslib_std_string_find", rslib_std_string_find},
            {"rslib_std_string_find_from", rslib_std_string_find_from},
            {"rslib_std_string_rfind", rslib_std_string_rfind},
            {"rslib_std_string_rfind_from", rslib_std_string_rfind_from},
            {"rslib_std_string_trim", rslib_std_string_trim},
            {"rslib_std_string_split", rslib_std_string_split},
            {"rslib_std_string_append_char", rslib_std_string_append_char},
            {"rslib_std_string_append_cchar", rslib_std_string_append_cchar},
            {"rslib_std_array_create", rslib_std_array_create},
            {"rslib_std_serialize", rslib_std_serialize},
            {"rslib_std_parse_array_from_string", rslib_std_parse_array_from_string},
            {"rslib_std_create_str_by_wchar", rslib_std_create_str_by_wchar},
            {"rslib_std_create_str_by_ascii", rslib_std_create_str_by_ascii},
            {"rslib_std_lengthof", rslib_std_lengthof},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_array_empty", rslib_std_array_empty},
            {"rslib_std_array_get", rslib_std_array_get},
            {"rslib_std_array_get_or_default", rslib_std_array_get_or_default},
            {"rslib_std_array_find", rslib_std_array_find},
            {"rslib_std_array_iter_next", rslib_std_array_iter_next},
            {"rslib_std_array_iter", rslib_std_array_iter},
            {"rslib_std_array_connect", rslib_std_array_connect},
            {"rslib_std_array_sub", rslib_std_array_sub},
            {"rslib_std_array_subto", rslib_std_array_subto},
            {"rslib_std_array_front", rslib_std_array_front},
            {"rslib_std_array_back", rslib_std_array_back},
            {"rslib_std_array_front_val", rslib_std_array_front_val},
            {"rslib_std_array_back_val", rslib_std_array_back_val},
            {"rslib_std_array_create", rslib_std_array_create},
            {"rslib_std_serialize", rslib_std_serialize},
            {"rslib_std_parse_array_from_string", rslib_std_parse_array_from_string},
            {"rslib_std_create_str_by_wchar", rslib_std_create_str_by_wchar},
            ...
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_array_empty", rslib_std_array_empty},
            {"rslib_std_array_resize", rslib_std_array_resize},
            {"rslib_std_array_shrink", rslib_std_array_shrink},
            {"rslib_std_array_insert", rslib_std_array_insert},
            {"rslib_std_array_swap", rslib_std_array_swap},
            {"rslib_std_array_copy", rslib_std_array_copy},
            {"rslib_std_array_get", rslib_std_array_get},
            {"rslib_std_array_add", rslib_std_array_add},
            {"rslib_std_array_connect", rslib_std_array_connect},
            {"rslib_std_array_sub", rslib_std_array_sub},
            {"rslib_std_array_subto", rslib_std_array_subto},
            {"rslib_std_array_pop", rslib_std_array_pop},
            {"rslib_std_array_dequeue", rslib_std_array_dequeue},
            {"rslib_std_array_pop_val", rslib_std_array_pop_val},
            {"rslib_std_array_dequeue_val", rslib_std_array_dequeue_val},
            {"rslib_std_array_remove", rslib_std_array_remove},
            {"rslib_std_array_find", rslib_std_array_find},
            {"rslib_std_array_clear", rslib_std_array_clear},
            {"rslib_std_array_iter_next", rslib_std_array_iter_next},
            {"rslib_std_array_iter", rslib_std_array_iter},
            {"rslib_std_array_front", rslib_std_array_front},
            {"rslib_std_array_back", rslib_std_array_back},
            ...
            {"rslib_std_array_back_val", rslib_std_array_back_val},
            {"rslib_std_serialize", rslib_std_serialize},
            {"rslib_std_parse_map_from_string", rslib_std_parse_map_from_string},
            {"rslib_std_lengthof", rslib_std_lengthof},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_map_only_get", rslib_std_map_only_get},
            {"rslib_std_map_find", rslib_std_map_find},
            {"rslib_std_map_get_or_default", rslib_std_map_get_or_default},
            {"rslib_std_map_keys", rslib_std_map_keys},
            {"rslib_std_map_vals", rslib_std_map_vals},
            {"rslib_std_map_empty", rslib_std_map_empty},
            {"rslib_std_map_iter_next", rslib_std_map_iter_next},
            {"rslib_std_map_iter", rslib_std_map_iter},
            {"rslib_std_serialize", rslib_std_serialize},
            {"rslib_std_parse_map_from_string", rslib_std_parse_map_from_string},
            {"rslib_std_map_create", rslib_std_map_create},
            {"rslib_std_map_reserve", rslib_std_map_reserve},
            {"rslib_std_map_set", rslib_std_map_set},
            {"rslib_std_lengthof", rslib_std_lengthof},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_make_dup", rslib_std_make_dup},
            {"rslib_std_map_find", rslib_std_map_find},
            {"rslib_std_map_only_get", rslib_std_map_only_get},
            {"rslib_std_map_get_or_default", rslib_std_map_get_or_default},
            {"rslib_std_map_get_or_set_default", rslib_std_map_get_or_set_default},
            {"rslib_std_map_swap", rslib_std_map_swap},
            {"rslib_std_map_copy", rslib_std_map_copy},
            {"rslib_std_map_keys", rslib_std_map_keys},
            {"rslib_std_map_vals", rslib_std_map_vals},
            {"rslib_std_map_empty", rslib_std_map_empty},
            {"rslib_std_map_remove", rslib_std_map_remove},
            {"rslib_std_map_clear", rslib_std_map_clear},
            {"rslib_std_map_iter_next", rslib_std_map_iter_next},
            {"rslib_std_map_iter", rslib_std_map_iter},
            {"rslib_std_int_to_hex", rslib_std_int_to_hex},
            {"rslib_std_int_to_oct", rslib_std_int_to_oct},
            {"rslib_std_hex_to_int", rslib_std_hex_to_int},
            {"rslib_std_oct_to_int", rslib_std_oct_to_int},
            {"rslib_std_handle_to_hex", rslib_std_handle_to_hex},
            {"rslib_std_handle_to_oct", rslib_std_handle_to_oct},
            {"rslib_std_hex_to_handle", rslib_std_hex_to_handle},
            {"rslib_std_oct_to_handle", rslib_std_oct_to_handle},
            {"rslib_std_gchandle_close", rslib_std_gchandle_close},
            {"rslib_std_debug_breakpoint", rslib_std_debug_breakpoint},
            {"rslib_std_debug_attach_default_debuggee", rslib_std_debug_attach_default_debuggee},
            {"rslib_std_debug_disattach_default_debuggee", rslib_std_debug_disattach_default_debuggee},
            {"rslib_std_debug_callstack_trace", rslib_std_debug_callstack_trace},
            {"rslib_std_macro_lexer_error", rslib_std_macro_lexer_error},
            {"rslib_std_macro_lexer_peek", rslib_std_macro_lexer_peek},
            {"rslib_std_macro_lexer_next", rslib_std_macro_lexer_next},
            {"rslib_std_macro_lexer_nextch", rslib_std_macro_lexer_nextch},
            {"rslib_std_macro_lexer_peekch", rslib_std_macro_lexer_peekch},
            {"rslib_std_macro_lexer_current_path", rslib_std_macro_lexer_current_path},
            {"rslib_std_macro_lexer_current_rowno", rslib_std_macro_lexer_current_rowno},
            {"rslib_std_macro_lexer_current_colno", rslib_std_macro_lexer_current_colno},
            {"rslib_std_call_shell", rslib_std_call_shell},
            {"rslib_std_get_env", rslib_std_get_env},
