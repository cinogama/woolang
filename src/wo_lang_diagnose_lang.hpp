// LANG-STAGE TYPED DIAGNOSES (wo::diagnose::lang2)
//
...
//
// Their render() calls into LangContext members, so these payloads require
// the complete wo_lang.hpp types: unlike wo_lang_diagnose.hpp - which sits
// at the top of the include chain with only a forward-declared LangContext -
// this header may only be processed once LangContext is complete. The
// wo_lang.hpp include below makes that ordering explicit; record these
// diagnoses only from the lang-stage translation units.
#pragma once
