...
namespace wo
{
    ...
    void gchandle_base_t::set_custom_mark_callback(gcmark_func_t callback)
    {
        ...
        m_custom_marker.m_marker63 = reinterpret_cast<uintptr_t>(callback);
#else
        m_custom_marker.m_marker32 = reinterpret_cast<uintptr_t>(callback);
#endif
    }
...
#ifdef WO_PLATFORM_64
        m_custom_marker.m_marker63 = reinterpret_cast<uintptr_t>(unit_may_null);
#else
        m_custom_marker.m_marker32 = reinterpret_cast<uintptr_t>(unit_may_null);
#endif
}
