// COMPILER DIAGNOSES - ALL STAGES
//
// This is the single home of the compiler/lexer's diagnostic payloads and
// message-fragment macros. It is deliberately processed in two phases by
// every translation unit:
//
//   Phase 1 (WO_LANG_DIAGNOSE_HPP): the diagnose infrastructure
//   (lang_diagnose_t / diagnose_model_t / format / is_diagnose_t), the
//   message-fragment macros and every payload that carries no lang-instance
//   fields. Only a forward declaration of LangContext is needed here, so
//   this phase is pulled in at the top of the include chain by
//   wo_compiler_lexer.hpp, long before wo_lang.hpp defines anything.
//
//   Phase 2 (WO_LANG_DIAGNOSE_LANG_STAGE_HPP): payloads holding pointers to
//   lang instances (type / value / symbol). Their render() calls into
//   LangContext members, so this phase is skipped until wo_lang.hpp
...
#ifndef WO_LANG_DIAGNOSE_HPP
#define WO_LANG_DIAGNOSE_HPP
...
//
// This section is only processed after wo_lang.hpp's types are complete:
// wo_lang.hpp defines WO_LANG_DIAGNOSE_LANG_STAGE and includes this header
// again at its very end.
#ifdef WO_LANG_DIAGNOSE_LANG_STAGE
#ifndef WO_LANG_DIAGNOSE_LANG_STAGE_HPP
#define WO_LANG_DIAGNOSE_LANG_STAGE_HPP
...
#endif // WO_LANG_DIAGNOSE_LANG_STAGE_HPP
#endif // WO_LANG_DIAGNOSE_LANG_STAGE
