    ...
    namespace ast
    {
        ...
        bool AstDeclareAttribue::modify_attrib(lexer& lex, AstToken* attrib_token)
        {
            ...
            case lex_type::l_static:
                if (m_lifecycle)
                {
                    lex.record_lang_error(lexer::msglevel_t::error, attrib_token, diagnose::parser::err_repeat_attribute{});
                    return false;
                }
        ...
        AstValueIROpnum::AstValueIROpnum(const woort_IRValue* spec_opnum)
