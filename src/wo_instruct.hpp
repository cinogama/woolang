...
#define WO_OPCODE_DR2SG(OPCODE)\
    ...
    OPCODE##ss = OPCODE | 0b11
        ...
        enum opcode : uint8_t
        {
            reserved = WO_OPCODE_SPACE(RESERVED_0),
            RESERVED_0 = reserved | 0b00,
            RESERVED_1 = reserved | 0b01,
            RESERVED_2 = reserved | 0b10,
            RESERVED_3 = reserved | 0b11,
            ...
            jnequbg = jnequb | 0b00,
            RESERVED_6 = jnequb | 0b01,
            jnequbs = jnequb | 0b10,
            RESERVED_7 = jnequb | 0b11,
            call = WO_OPCODE_SPACE(CALL),
            callg = call | 0b00,
            RESERVED_8 = call | 0b01,
            calls = call | 0b10,
            RESERVED_9 = call | 0b11,
            calln = WO_OPCODE_SPACE(CALLN),
            callnwo = calln | 0b00,
            callnfpslow = calln | 0b01,
            RESERVED_10 = calln | 0b10,
            callnfp = calln | 0b11,
