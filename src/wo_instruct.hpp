...
#define WO_OPCODE_DR2SG(OPCODE)\
    ...
    OPCODE##ss = OPCODE | 0b11
        ...
        enum opcode : uint8_t
        {
            ...
            jnequbg = jnequb | 0b00,
            RESERVED_2 = jnequb | 0b01,
            jnequbs = jnequb | 0b10,
            RESERVED_3 = jnequb | 0b11,
            call = WO_OPCODE_SPACE(CALL),
            callg = call | 0b00,
            RESERVED_4 = call | 0b01,
            calls = call | 0b10,
            RESERVED_5 = call | 0b11,
            calln = WO_OPCODE_SPACE(CALLN),
            callnwo = calln | 0b00,
            callnfpslow = calln | 0b01,
            RESERVED_6 = calln | 0b10,
            callnfp = calln | 0b11,
