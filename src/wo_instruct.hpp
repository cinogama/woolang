    ...
    OPCODE##ss = OPCODE | 0b11
        ...
        */
        ...
        enum opcode : uint8_t
        {
            ...
            negi = WO_OPCODE_SPACE(NEGI),
            WO_OPCODE_DR2SG(negi),
            negr = WO_OPCODE_SPACE(NEGR),
            WO_OPCODE_DR2SG(negr),
            ...
            WO_OPCODE_DR2SG(lor),
            lts = WO_OPCODE_SPACE(LTS),
            WO_OPCODE_DR2SG(lts),
            gts = WO_OPCODE_SPACE(GTS),
            WO_OPCODE_DR2SG(gts),
            elts = WO_OPCODE_SPACE(ELTS),
            WO_OPCODE_DR2SG(elts),
            egts = WO_OPCODE_SPACE(EGTS),
            WO_OPCODE_DR2SG(egts),
        ...
        enum extern_opcode_page_0 : uint8_t
        {
            ...
            lth = WO_OPCODE_SPACE(LTH),
            WO_OPCODE_DR2SG(lth),
            gth = WO_OPCODE_SPACE(GTH),
            WO_OPCODE_DR2SG(gth),
            elth = WO_OPCODE_SPACE(ELTH),
            WO_OPCODE_DR2SG(elth),
            egth = WO_OPCODE_SPACE(EGTH),
            WO_OPCODE_DR2SG(egth),
        };
