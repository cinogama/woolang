    ...
    return true;                                    \
        ...
        struct pass_class_define : public astnode_builder
        {
            static std::any build(lexer& lex, const std::wstring& name, inputs_t& input)
            {
                ...
                bool decl_naming = WO_NEED_TOKEN(1).type == +lex_type::l_naming;
                ...
                {
                    ast_cls_namespace->in_scope_sentence = dynamic_cast<ast_list*>(WO_NEED_AST(5));
                ...
                if (!ast_empty::is_empty(input[4]))
                {
                    ...
                    {
                        ast_type* depending_naming = dynamic_cast<ast_type*>(dynamic_cast<ast_list*>(WO_NEED_AST(4))->children);
